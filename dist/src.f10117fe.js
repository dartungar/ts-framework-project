...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/models/EventManager.ts":[function(require,module,exports) {
"use strict";
...
var EventManager = function EventManager() {
  ...
  this.trigger = function (eventName) {
    var events = _this.events[eventName];
...
exports.Model = void 0; // General model
...
function () {
  ...
  _createClass(Model, [{
    ...
    value: function save() {
      ...
      this.sync.save(data).then(function (resp) {
        _this.trigger("save");
    ...
    value: function fetch() {
      ...
      var id = this.get("id"); // костыль

      if (typeof id === "number") {
        this.sync.fetch(id).then(function (resp) {
          _this2.set(resp.data);

          console.log("fetched info");
        }).catch(function (reason) {
          return console.log("error saving info");
        });
      } else {
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/dartu/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
function () {
  ...
  _createClass(ApiSync, [{
    ...
    value: function fetch(id) {
      return axios_1.default.get("".concat(this.url, "/").concat(id)); // TODO: как понять, когда возвращаем response?
    }
  }, {
    key: "save",
    value: function save(data) {
      ...
      if (id) {
        return axios_1.default.put("".concat(this.url, "/").concat(id), data);
      } else {
        return axios_1.default.post("".concat(this.url), data);
      }
    }
  }]);
...
/*#__PURE__*/
function () {
  function Collection(url, deserializer) {
  ...
  _createClass(Collection, [{
    ...
    value: function fetch() {
      ...
      axios_1.default.get(this.url).then(function (resp) {
        var data = resp.data;
        var newModels = [];
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var d = _step.value;
            newModels.push(_this.deserializer(d));
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
},{"axios":"node_modules/axios/index.js","./EventManager":"src/models/EventManager.ts"}],"src/models/User.ts":[function(require,module,exports) {
"use strict";
...
exports.User = exports.BASE_URL = void 0;
...
exports.BASE_URL = "http://localhost:3000/users"; // User model
...
function (_Model_1$Model) {
  ...
  _createClass(User, null, [{
    ...
    value: function buildUser(attrs) {
      return new User(new EventManager_1.EventManager(), new ApiSync_1.ApiSync(exports.BASE_URL), new Attributes_1.Attributes(attrs));
    }
  }, {
    key: "buildCollection",
    value: function buildCollection() {
      return new Collection_1.Collection(exports.BASE_URL, function (json) {
...
exports.User = User;
},{"./EventManager":"src/models/EventManager.ts","./Model":"src/models/Model.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
  ...
  _createClass(CollectionView, [{
    ...
    value: function render() {
      ...
      this.collection.models.forEach(function (model) {
        ...
        _this.parentElement.appendChild(elementDiv);

        _this.renderItem(model, elementDiv);
      });
    }
  }]);
...
function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this.onClickSetNameBtn = function () {
    ...
    _this.onClickSetAgeBtn = function () {
      _this.model.setRandomAge();
    };

    _this.onClickSaveBtn = function () {
      _this.model.save();
    };
  ...
  _createClass(UserForm, [{
    ...
    value: function template() {
      return "\n        <div>\n            <input id=\"name-input\" placeholder=\"".concat(this.model.get("name"), "\"></input>\n            <button class=\"set-name\">set name</button>\n            <button class=\"save\">save</button>\n            <button class=\"set-age\">set random age</button>\n        </div>\n        ");
    }
  }]);
...
function (_View_1$View) {
  ...
  _createClass(UserShow, [{
    key: "template",
    value: function template() {
      return "\n        <div>\n            <h1>User</h1>\n            <p>Name: ".concat(this.model.get("name"), "</p>\n            <p>Age: ").concat(this.model.get("age"), "</p>\n        </div>\n        ");
    }
  }]);
...
},{"./UserForm":"src/views/UserForm.ts","./UserShow":"src/views/UserShow.ts","./View":"src/views/View.ts"}],"src/views/UserList.ts":[function(require,module,exports) {
"use strict";
...
function (_CollectionView_1$Col) {
  ...
  _createClass(UserList, [{
    ...
    value: function renderItem(model, itemParent) {
      var item = new UserEdit_1.UserEdit(itemParent, model);
      item.render();
    }
  }]);
...
},{"./CollectionView":"src/views/CollectionView.ts","./UserEdit":"src/views/UserEdit.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var UserList_1 = require("./views/UserList"); //const usr = User.buildUser({ name: "Ragnar Lothbrok", age: 35 });


var usrCollection = User_1.User.buildCollection();
usrCollection.fetch();
var rootElement = document.getElementById("root");
setTimeout(function () {
  if (rootElement) {
    var userList = new UserList_1.UserList(rootElement, usrCollection);
    userList.render();
    console.log(userList);
  } else throw new Error("Root element not found");
}, 3000);
},{"./models/User":"src/models/User.ts","./views/UserList":"src/views/UserList.ts"}],"C:/Users/dartu/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/dartu/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
